...
def test_dump_handles_oserror(mocker):
    """
    ppgdump.dump returns a reasonable error if pg_dump isn't installed.
    """
...
def test_dump_file_name_with_timestamp():
    ...
    pgdump.db_file_name returns the name of the database
    """
    timestamp = "2017-12-03T13:14:19"
    assert pgdump.dump_file_name(url, timestamp) == "db_one-2017-12-03T13:14:19.sql"
